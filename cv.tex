...
%-------------------------------------------------------------------------------
\name{Daniel Felipe Victoria Muñoz}{}
\position{PhD Student}
\address{University of Münster, Institute of Pharmacy and Medicinal Chemistry Münster, Germany 48149}

%\mobile{+1 000-000-0000}
\email{danielfvictoriam@gmail.com}
\github{FelPVic}
\linkedin{FelPVic}
% \gitlab{my-gitlab-id}
...
% \homepage{https://www.uni-muenster.de/Chemie.pz/forschen/ag/koch/mitarbeiter/victoria.html}
...
\makecvfooter
  {March 2025}
  {Felipe Victoria-Muñoz ~~~·~~~ Curriculum Vitae}
  {\thepage}
